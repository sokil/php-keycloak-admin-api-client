    ...
    public function testPositive()
    {
        ...
        $client = KeycloakClientBuilder::build(
            function (
                ...
                $this->assertSame(
                    'http://keycloak/admin/realms/some-realm/users/92ccf7ea-bc64-48e6-ba58-792db362beda',
                    $url
                );
        ...
        $userRepresentation = $client->call(
            new GetUserRequest(
                Uuid::fromString("92ccf7ea-bc64-48e6-ba58-792db362beda")
            )
        );
